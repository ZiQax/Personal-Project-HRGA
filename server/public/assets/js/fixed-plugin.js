...
const buttonNavbarFixed = document.querySelector('[navbarFixed]')

const sidenav = document.querySelector('aside')
const sidenav_icons = sidenav.querySelectorAll('li a div')

const sidenav_target = '../pages/' + pageName + '.html'

const whiteBtn = document.querySelector('[transparent-style-btn]')
const darkBtn = document.querySelector('[white-style-btn]')

const non_active_style = ['bg-none', 'bg-transparent', 'text-blue-500', 'border-blue-500']
const active_style = ['bg-gradient-to-tl', 'from-blue-500', 'to-violet-500', 'bg-blue-500', 'text-white', 'border-transparent']

const white_sidenav_classes = ['bg-white', 'shadow-xl']
// var white_sidenav_highlighted = ["shadow-xl"];
// var white_sidenav_icons = ["bg-white"];

const black_sidenav_classes = ['bg-slate-850', 'shadow-none']
// var black_sidenav_highlighted = ["shadow-none"];
// var black_sidenav_icons = ["bg-gray-200"];

const sidenav_highlight = document.querySelector('a[href=' + CSS.escape(sidenav_target) + ']')
...
function sidebarColor (a) {
  ...
  let activeSidenavIconColorClass

  const checkedSidenavIconColor = 'bg-' + color + '-500/30'

  const sidenavIcon = document.querySelector('a[href=' + CSS.escape(sidenav_target) + ']')
...
const dark_mode_toggle = document.querySelector('[dark-toggle]')
