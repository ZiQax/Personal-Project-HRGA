...
const { paginattedPeminjamanKendaraan } = require('../middleware/pagination')

router.get('/', getPeminjamanKendaraan)
router.get('/pagination', paginattedPeminjamanKendaraan, peminjamanKendaraan.getPaginationKendaraan)
